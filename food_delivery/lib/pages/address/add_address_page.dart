    ...
    return Scaffold(
      ...
      body: GetBuilder<UserController>(builder: (userController){
        ...
        return GetBuilder<LocationController>(builder: (locationController){
          ...
          print("Địa chỉ của bạn là "+_addressController.text);
          ...
          return SingleChildScrollView(
            child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: Dimensions.height10,),
                  AppTextField(textController: _contactPersonName, hintText: "Tên", icon: Icons.person),
                  SizedBox(height: Dimensions.height20,),
                  Padding(
                    padding: EdgeInsets.only(left: Dimensions.width20),
                  ...
                  SizedBox(height: Dimensions.height10,),
                  AppTextField(textController: _contactPersonNumber, hintText: "Số điện thoại", icon: Icons.phone),
                ]
            ),
          );
        });
